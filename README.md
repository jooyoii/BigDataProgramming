...
|---|---:|---:|---:|---:|
| RNN | 0.6240 | 0.5913 | 0.8029 | 0.6810 |
| CNN | 0.6369 | 0.6091 | 0.7639 | 0.6778 |
| LSTM | 0.6669 | 0.6844 | 0.6196 | 0.6504 |
| BERT | 0.6415 | 0.6833 | 0.5274 | 0.5953 |
| RoBERTa | 0.6570 | 0.6746 | 0.6067 | 0.6388 |
| 제안 모델 | **0.7604** | **0.7149** | **0.8660** | **0.7833** |
...
|---|---|---:|---:|---:|---:|
| `text_only` | 텍스트만 사용 | 0.6750 | 0.6616 | 0.7166 | 0.6880 |
| `text_basic` | 텍스트 + 기본 언어적 특징 | 0.6745 | 0.6589 | 0.7237 | 0.6898 |
| `text_readability` | 텍스트 + 가독성 특징 | 0.6736 | 0.6688 | 0.6879 | 0.6782 |
| `text_sentiment` | 텍스트 + 감정 특징 | 0.6753 | 0.6587 | 0.7274 | 0.6914 |
| `text_behavioral` | 텍스트 + 행동 특징 | **0.7579** | **0.7155** | **0.8563** | **0.7796** |
